...
namespace HCMed_Interop.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public void InicializarDados()
        {
            ...
            Conselho conselho1 = new Conselho(1, "Conselho Regional de Medicina", "CRM", uf1);
            Conselho conselho2 = new Conselho(2, "Conselho Regional de Enfermagem", "COREN", uf1);
            ...
            ProfissionalSaude profissional1 = new ProfissionalSaude(1, "Roberto", "Vasquez Marinho", CategoriaProfissional.Doutor, especialidade1, "154986", conselho1, "23789");
            ProfissionalSaude profissional2 = new ProfissionalSaude(2, "Fernanda", "Martins Ambrósio", CategoriaProfissional.Doutor, especialidade2, "152741", conselho1, "23174");
            ProfissionalSaude profissional3 = new ProfissionalSaude(3, "Marcus Vinícius", "de Almeida Teles", CategoriaProfissional.Doutor, especialidade4, "153158", conselho1, "18472");
            ProfissionalSaude profissional4 = new ProfissionalSaude(4, "Márcia", "Fonseca Barbosa", CategoriaProfissional.Enfermeiro, especialidade5, "159342", conselho2, "17830");
            ProfissionalSaude profissional5 = new ProfissionalSaude(5, "Janaína", "Ribeiro de Oliveira", CategoriaProfissional.Enfermeiro, especialidade5, "159758", conselho2, "195612");

            Paciente paciente1 = new Paciente(1, "Maria Luiza", "Pereira Fernandes", Genero.Feminino, "7900012B", "paciente1.png");

            Consulta consulta1 = new Consulta(1, 1, 1, new DateTime(2021, 5, 5, 8, 30, 0), StatusConsulta.Realizada, paciente1, profissional1);
            Consulta consulta2 = new Consulta(2, 1, 2, new DateTime(2021, 8, 17, 9, 45, 0), StatusConsulta.Aguardando, paciente1, profissional2);
            ...
            RelatorioMedico relatorioMedico1 = new RelatorioMedico(1, 1, 1, new DateTime(2021, 5, 5), cid1);
            RelatorioMedico relatorioMedico2 = new RelatorioMedico(2, 1, 3, new DateTime(2019, 6, 17), cid3);

            Internacao internacao1 = new Internacao(1, 1, new DateTime(2019, 6, 17, 18, 43, 42), new DateTime(2019, 6, 20, 14, 31, 13), profissional3, paciente1, StatusInternacao.Finalizada, 3, "Paciente apresentou aceleração nos batimentos cardíacos e outros sintomas comuns de arritmia");

            TransicaoCuidados transicao1 = new TransicaoCuidados(1, 1, 5, new DateTime(2019, 6, 19, 12, 51, 23), "Paciente conduzida à observação por 24 horas, após passar por procedimento cirúrgico", paciente1, profissional5);
